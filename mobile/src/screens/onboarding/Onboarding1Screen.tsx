  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Encontre o serviço certo</Text>
        <Text style={styles.subtitle}>
          Conectamos você aos melhores profissionais da sua região com avaliações reais e preços transparentes.
        </Text>
